...
public enum Nutricao {
    ...
    SOBREPESO("IMC ALTO! Sobrepeso.",
            "Priorize alimentos de baixa densidade calórica e controle as porções. nConsuma proteínas magras e laticínios com baixo teor de gordura, escolha grãos integrais. Evite açúcares e gorduras processadas, e aumente a atividade física."),
